...
ztestOneSClass <- R6::R6Class(
  ...
  private = list(
    ...
    .populatePowerCurveESText = function(r, lst) {
      ...
      d50 <- pwr::pwr.norm.test(n = n, sig.level = alpha, power = .5, alternative = alt)$d
    ...
    .preparePowerCurveES = function(r, lst) {
      ...
      y <- pwr::pwr.norm.test(n = n, d = dd, sig.level = alpha, alternative = alt)$power
    ...
    .preparePowerCurveN = function(r, lst) {
      ...
      y <- pwr::pwr.norm.test(n = nn, d = d, sig.level = alpha, alternative = alt)$power
